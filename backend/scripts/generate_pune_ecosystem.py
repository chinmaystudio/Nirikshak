...
# Projects: b1000000-0000-0000-0000-000000000001 .. 08
# Contracts: c1000000-0000-0000-0000-000000000001 .. 03
# Milestones: fa000000-0000-0000-0000-000000000001 .. 06
# Progress Updates: fb000000-0000-0000-0000-000000000001 .. 02
# Complaints: fc000000-0000-0000-0000-000000000001 .. 03
# Tenders: fd000000-0000-0000-0000-000000000001 .. 02
# AI Insights: fe000000-0000-0000-0000-000000000001 .. 02

sql = """-- Pune Core Projects & Ecosystem Seed
...
with open(r"E:\Nirikshak\frontend\seed_chunks\pune_ecosystem_seed.sql", "w", encoding="utf-8") as f:
    f.write(sql)

print("Updated pune_ecosystem_seed.sql with 100% valid hexadecimal UUIDs!")
